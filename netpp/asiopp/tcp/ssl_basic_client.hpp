...
class ssl_basic_client : public basic_client<protocol_type>
{
public:
	...
	ssl_basic_client(asio::io_context& io_context, const protocol_endpoint& listen_endpoint,
    ...
    void start()
    {
        ...
        auto on_connection_established = [weak_this, socket]() mutable {
            ...
            socket->async_handshake(
                asio::ssl::stream_base::client, [weak_this, socket](const error_code& ec) mutable {
                    if(ec)
                    {
