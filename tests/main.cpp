...
int main(int argc, char* argv[])
{
    ...
    std::string host = "::1"; // ff05:e671:2015::1";
    uint16_t port = 2000;
    ...
    net::set_logger([](const std::string& msg) { std::cout << msg; });
...
//        		}
        ...
        //			if(is_server)
        //			{
        //				server = net::create_tcp_ssl_local_server(domain, cert_chain_file, private_key_file,
        // dh_file);
        //			}
        //			test(std::move(server), std::move(clients));
        //		}
